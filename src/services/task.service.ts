...
const ensureProjectBelongsToWorkspace =
  async (
    tx: Transaction,
    workspaceId: string,
    projectId: string
...
const ensureAssigneeIsActiveWorkspaceMember =
  async (
    tx: Transaction,
    workspaceId: string,
    assigneeId:
...
export const createTaskInDb =
  async (
    ...
    return await db.transaction(
      async (tx) => {
        await ensureProjectBelongsToWorkspace(
          tx,
          data.workspaceId,
          data.projectId
        );
...
export const getProjectTasksFromDb =
  async (
    data:
...
export const getTaskByIdFromDb =
  async (
    workspaceId: string,
    projectId: string,
    taskId: string
...
export const updateTaskStatusInDb =
  async (data: {
    workspaceId: string;
    projectId: string;
    taskId: string;
...
export const unarchiveTaskInDb =
  async (data: {
    workspaceId: string;
    projectId: string;
    taskId: string;
...
export const duplicateTaskInDb =
  async (data: {
    workspaceId: string;
    projectId: string;
    taskId: string;
