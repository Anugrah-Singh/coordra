...
// Explicit Zod enum mapping to your PostgreSQL pgEnum
...
export const createTaskSchema = z.object({
    body: z.object({
        ...
        assigneeId: z.string().uuid({ message: 'Invalid Assignee ID' }).optional().nullable(),
        dueDate: z.string().datetime({ message: 'Due date must be a valid ISO datetime' }).optional().nullable(),
    }),
    params: z.object({
