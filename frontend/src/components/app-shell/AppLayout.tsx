    ...
    <div className="min-h-screen bg-background text-foreground xl:grid xl:grid-cols-[17rem_1fr]">
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-sidebar-border px-4">
          <Link
            className="inline-flex items-center gap-2.5 font-heading text-base font-bold tracking-tight text-sidebar-foreground"
            href="/app"
          ...
          <button
            className="inline-flex size-11 items-center justify-center rounded-lg text-sidebar-foreground/60 hover:bg-sidebar-accent hover:text-sidebar-foreground xl:hidden"
            onClick={closeSidebar}
            type="button"
          ...
          <div className="flex flex-col gap-1 border-t border-sidebar-border px-3 py-4 text-xs text-sidebar-foreground/55 [&>span]:mb-2 [&>span]:px-3 [&>span]:font-mono [&>span]:uppercase [&>span]:tracking-[.14em]">
            ...
            {workspaceData.projects.slice(0, 5).map((project) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    'flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-sidebar-foreground/65 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
      ...
      <div className="min-w-0 xl:col-start-2">
        <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b bg-background/90 px-4 backdrop-blur-xl lg:px-8">
          <button
            className="inline-flex size-11 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:hidden"
            type="button"
          ...
          <div className="min-w-0 flex-1 [&>span]:block [&>span]:truncate [&>span]:font-heading [&>span]:font-semibold [&>small]:font-mono [&>small]:text-[10px] [&>small]:uppercase [&>small]:tracking-wider [&>small]:text-muted-foreground">
            ...
            {workspaceData.currentWorkspace?.role ? (
              <small>{workspaceData.currentWorkspace.role}</small>
            ) : null}
          </div>
