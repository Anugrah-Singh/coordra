...
ALTER TABLE "task_labels" ADD CONSTRAINT "task_labels_id_tasks_id_fk" FOREIGN KEY ("id") REFERENCES "public"."tasks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
